...
export const metadata={title:'فروشگاه زیورها',alternates:{canonical:'/shop'},openGraph:{title:'فروشگاه زیورهای ماه‌نشان',url:'/shop',images:['/images/rose-campaign.png']}};
